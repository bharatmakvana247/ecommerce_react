        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                ...
                <a href="javascript:void(0)" onClick="addBrandModal()" href="javascript:void(0)"
                    class="btn btn-sm btn-primary"><i class="fa fa-fw fa-plus me-1"></i> Add Brand
                </a>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        function addBrandModal() {
            ...
            $('#brandModal').html("Add Brand"); //<h4> title
        ...
        //Show Brand Modal
        $(document).on("click", "a.ShowBrands", function(e) {
            console.log("load Brand Index :)");
            let row = $(this);
