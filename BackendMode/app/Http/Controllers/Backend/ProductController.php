        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($products)->addIndexColumn()
                ...
                ->addColumn('action', function (Product $product) {
                    $action  = '';
                    $action .= '<a class="btn btn-warning btn-circle btn-sm" style="margin-right : 2px" href=' . route('admin.product.edit', [$product->product_id]) . '><i class="fa fa-pencil" data-toggle="tooltip" title="Edit"></i></a>';
                    $action .= '<a class="btn btn-danger btn-circle btn-sm m-l-10 ml-1 mr-1" style="margin-right : 2px" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" data-id=' .  route('admin.product.delete', [$product->product_id]) . ' onclick="deleteAlert(event)"></i></a>';
