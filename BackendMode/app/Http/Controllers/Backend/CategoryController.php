        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($categories)->addIndexColumn()
                ...
                ->addColumn('action', function (Category $category) {
                    $action  = '';
                    $action .= '<a class="btn btn-warning btn-circle btn-sm" style="margin-right : 3px" href=' . route('admin.category.edit', [$category->category_id]) . '><i class="fa fa-pencil" data-toggle="tooltip" title="Edit"></i></a>';
                    $action .= '<a class="btn btn-danger btn-circle btn-sm m-l-10 ml-1 mr-1" style="margin-right : 3px" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" data-id=' .  route('admin.category.delete', [$category->category_id]) . ' onclick="deleteAlert(event)"></i></a>';
